...
INSERT ignore INTO news (title, description, match_id, sport_id) 
VALUES ('Exciting Match Ahead', 'Get ready for an exciting match between Team A and Team B!', 1, 1);

INSERT ignore INTO news (title, description, match_id, sport_id) 
VALUES ('Key Players to Watch', 'Learn about the key players to watch out for in this match.', 2, 1);

-- Insert dummy news with associated tours
INSERT ignore INTO news (title, description, tour_id, sport_id) 
VALUES ('Premier League Kickoff', 'Join us as we kick off the new season of Premier League with a bang!', 1, 1);

INSERT ignore INTO news (title, description, tour_id, sport_id) 
VALUES ('Test Series Schedule', 'Check out the schedule for the upcoming Test Series matches.', 2, 1);
